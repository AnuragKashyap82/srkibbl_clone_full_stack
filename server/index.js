...
const DB = 'mongodb+srv://anurag82:anurag82@cluster0.xh5ycgh.mongodb.net/?retryWrites=true&w=majority';
...
io.on('connection', (socket)=>{
    ...
    socket.on('join-game', async({nickname, name})=>{
      try {
        ...
        if(!room){
          socket.emit('notCorrectGame', 'Please Enter a valid game')
          return;
          }
          if(room.isJoin){
            let player = {
          ...
          socket.emit('notCorrectGame', 'The game is in progress, please try latter')
